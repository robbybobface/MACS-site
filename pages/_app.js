...
import { Box, ThemeProvider, Typography, LinearProgress, Grid, Card, CardActionArea, CardContent } from "@mui/material";
						...
						<Grid
							...
							<Box
								...
								<Box sx={{ display: "flex", flexDirection: "column" }}>
									...
									<LinearProgress color='hexagonBlueFull' sx={{ mt: -6, maxWidth: "49%" }} />
								</Box>
								<Box
									sx={{
										display: "flex",
