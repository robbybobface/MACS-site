...
import PageOne from "../components/TeamMACS/PageOne";
import MobileContentTeamMACS from "../components/TeamMACS/MobileContentTeamMACS";

export default function TeamMACS() {
	...
	return (
		<>
			...
			{isMobile && <MobileContentTeamMACS />}
			{!isMobile && (
				<Parallax className={`${styles.parallaxContainer} parallax-scroll`} ref={parallax} pages={1}>
					<PageOne offset={0} gradient='purpleAlt' onClick={() => allowScroll(1)} router={router} />
				</Parallax>
			)}
		</>
	);
