...
function SwitchLogoAlt(props) {
	return (
		<svg width={92} height={164} viewBox='0 0 92 164' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
			<g filter='url(#filter10_i_31_2208)'>
				<rect x={30} width={31.0435} height={119} rx={15.5217} fill='#111' />
			</g>
			<g filter='url(#filter11_d_31_2208)'>
				<circle cx={45.5217} cy={103.478} r={15.5217} fill='url(#paint10_linear_31_2208)' />
				<circle cx={45.5217} cy={103.478} r={14.0217} stroke='url(#paint11_linear_31_2208)' strokeWidth={3} />
			</g>
			<defs>
				<filter
					id='filter10_i_31_2208'
					x={30}
					y={0}
					width={31.0439}
					height={121}
