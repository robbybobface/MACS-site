	...
	<>
									...
									<CardContent
										...
										<Grid
											...
											<Grid
												...
												<Button variant='contained' onClick={() => router.push("/controller")}>
													Learn More
												</Button>
											</Grid>
										</Grid>
									...
									<CardContent
										...
										<Grid
											...
											<Grid
												...
												<Button variant='contained' onClick={() => router.push("/application")}>
													Learn More
												</Button>
											</Grid>
										</Grid>
		...
		<ParallaxLayer
			...
			<Box
				...
				sx={{ position: "absolute", right: "50%", top: { xs: "15%", md: "0%" }, transform: "rotate(212deg)" }}>
				<HexGrid
					id='module-grid-19'
					height={"20vh"}
					width={"auto"}
